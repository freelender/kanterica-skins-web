...
document.addEventListener('click', function (e) {
    ...
    switch (e.target.getAttribute('data-action')) {
        ...
        case 'language_change':
            ...
            document.cookie = `kanterica_language=${lang}; path=/;expires=${date}`;
        ...
        case 'color_select':
            ...
            let ThemeCookie_sel = cookies.find(cookie => cookie.includes('kanterica_theme'));
            let checked = '', input = '';
            if(ThemeCookie_sel) {
            ...
            break;
        case 'theme_check':
            let ThemeCookie_choose = cookies.find(cookie => cookie.includes('kanterica_theme'));
            ...
            if(!ThemeCookie_choose) {
                ...
                document.cookie = `kanterica_theme=${currentTheme_color}; path=/;expires=${date}`;
                ...
                ToggleLoading();
                document.cookie = `kanterica_theme=; path=/;expires=Thu, 01 Jan 1970 00:00:01 GMT`;
        ...
        case 'theme_change':
            ...
            e.target.querySelector('input').oninput = function(e) {
                ...
                document.cookie = `kanterica_theme=${e.target.value}; path=/;expires=${date}`;
