...
if($Website_Settings['language'] && isset($_COOKIE['kanterica_language'])
&& file_exists(realpath("./translation/".$_COOKIE['kanterica_language'].".json"))) {
    $translations = json_decode(file_get_contents("./translation/".$_COOKIE['kanterica_language'].".json"));
}else if($Website_Settings['language'] && !isset($_COOKIE['kanterica_language'])
...
if(!isset($documentError_Code)) {
    ...
    if($Website_Settings['theme'] && isset($_COOKIE['kanterica_theme'])) {
        $Website_MainColor = $_COOKIE['kanterica_theme'];
