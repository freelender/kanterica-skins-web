...
<head>
    ...
    <title><?= $translations->website_name ?? 'Kanterica.xyz'; ?> - <?php if(isset($errors[$documentError_Code])) {echo 'Error '.$documentError_Code;}else {echo 'something happened';} ?>!</title>
</head>
<body <?= $bodyStyle ?? "" ?>>
    ...
    <div class="wrapper">
        ...
        <footer>
            <h3><?= $translations->website_name ?? 'Kanterica.xyz'; ?></h3>
        </footer>
    </div>
